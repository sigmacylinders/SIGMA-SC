page 70147 "NO Insurance List"
{
    PageType = List;
    SourceTable = "Insurance/Claim";
    ApplicationArea = All;
    Caption = 'UnInsured Item List';
    UsageCategory = Lists;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Reason for Non-Insurance"; Rec."Reason for Non-Insurance")
                {
                    ApplicationArea = All;
                }
    ...
    var
    begin
        rec.SetRange(Type, Rec.Type::UnInsured);
    end;
