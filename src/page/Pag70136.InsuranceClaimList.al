page 70136 "Insurance/Claim List"
{
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Claimed Value"; Rec."Claimed Value")
                {
                    ApplicationArea = All;
                    StyleExpr = StyleExprTxt;
                    Enabled = Rec."Claim Status" = Rec."Claim Status"::Claimed;
                }

                field("Insurance Claim Ref"; Rec."Insurance Claim Ref")
                {
                    ApplicationArea = All;
                    StyleExpr = StyleExprTxt;
                }

                field("Insurance Claim Date"; Rec."Insurance Claim Date")
                {
                    ApplicationArea = All;
                    StyleExpr = StyleExprTxt;
                }
    ...
    var
    begin
        rec.SetRange(Type, Rec.Type::Insurance);
    end;
