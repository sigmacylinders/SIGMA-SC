report 70111 "Job Transfer to Sales Order"
{
    Caption = 'Project Transfer to Sales Order';
    ProcessingOnly = true;
    ApplicationArea = All;
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    {
                        ApplicationArea = Jobs;
                        Caption = 'Append to Sales Order No.';
                        ...
                        begin
                            ...
                            if InvoiceNo <> '' then begin
                                SalesHeader.Get(SalesHeader."Document Type"::Order, InvoiceNo);
