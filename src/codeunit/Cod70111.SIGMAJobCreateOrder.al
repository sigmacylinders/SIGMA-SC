codeunit 70111 "SIGMA Job Create-Order"
{
...
#pragma warning restore AA0074
    ...
    var
        ...
        GetSalesInvoiceNo: Report "Job Transfer to Sales Order";
    ...
    begin
        ...
        SalesReceivablesSetup.SetLoadFields("Order Nos.", "Credit Memo Nos.");
    ...
    begin
        ...
        case JobPlanningLineInvoice."Document Type" of
            JobPlanningLineInvoice."Document Type"::Order:
                begin
                    SalesHeader.Get(SalesHeader."Document Type"::Order, JobPlanningLineInvoice."Document No.");
                    PAGE.RunModal(PAGE::"Sales Order", SalesHeader);//modified by AI 30/04/2025
                end;
