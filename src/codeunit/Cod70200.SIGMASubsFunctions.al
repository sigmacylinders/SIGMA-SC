codeunit 70200 "SIGMA Subs & Functions"
{
            ...
            IF PurchHeader.Receive then begin
                if PurchHeader."Gen. Bus. Posting Group" = 'FOREIGN' then begin
                    IF PurchLine."Qty. to Receive" <> 0 then begin
                        IF (PurchLine."Shipping By" = PurchLine."Shipping By"::Air) OR (PurchLine."Shipping By" = PurchLine."Shipping By"::Sea) /*OR (PurchLine."Shipping By" = PurchLine."Shipping By"::" ")*/ then//added on 27/05/2025//modified on 27/01/2026
                            PurchLine.TestField("BL/AWB ID");

                        IF (PurchLine."Shipping By" = PurchLine."Shipping By"::InLand) then /*(PurchLine."Shipping By" = PurchLine."Shipping By"::" ")*/ //added on 27/05/2025//modified on 27/01/2026
