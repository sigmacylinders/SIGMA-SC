tableextension 70208 "Document attachment Extension" extends "Document Attachment"
{    //Atatchment default
    fields
    {
        // Add changes to table fields here
        field(70200; "Attachment ID"; text[50])//Added on 29/10/2024 for init of attachment on the modules
        {
            DataClassification = ToBeClassified;
        }
        field(70201; "to be removed"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70202; "Attachment Mandatory"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        //AN 03/07/25
        field(70203; FileSizeTxt; Text[100])
        {
            Caption = 'File Size';
            Editable = false;
