tableextension 70200 "Purchase Line Exttension" extends "Purchase Line"
{
    ...
    fields
    {
        ...
        field(70223; "Packed Net Weight"; Decimal)
        {
        ...
        field(70224; "Packed Gross Weight"; Decimal)
        {
        ...
        field(70225; "Packed Volumetric Weight"; Decimal)
        {
        ...
        field(70226; "Packed Length"; Decimal)
        {
        ...
        field(70227; "Packed Height"; Decimal)
        {
        ...
        field(70228; "Packed Width"; Decimal)
        {
