tableextension 70217 "ItemExt" extends Item
{
    fields
    {
        field(70200; "Packed Net Weight"; Decimal)
        {
            Caption = 'Packed Net Weight';
        }

        field(70201; "Packed Gross Weight"; Decimal)
        {
            Caption = 'Packed Gross Weight';

        }

        field(70202; "Packed Volumetric Weight"; Decimal)
        {
            Caption = 'Packed Volumetric Weight';
        }

        field(70203; "Packed Length"; Decimal)
        {
            Caption = 'Packed Length';
        }

        field(70204; "Packed Height"; Decimal)
        {
        ...
        field(70205; "Packed Width"; Decimal)
        {
            Caption = 'Packed Width';

        }
        field(70206; "CBM"; Decimal)
        {
            Caption = 'CBM';
